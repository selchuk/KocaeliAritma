                        ...
                        ZStack {
                            ...
                            ZStack { //düğmeler ve ortadaki logo için
                                ...
                                VStack {
                                    ...
                                    HStack { //en alt satir
                                        Link(destination: URL(string: "https://kocaeliAritma.com")!){
                                            Image(systemName: "globe").padding(g.size.width/20)
                                        }
                                        Spacer()
                                        ...
                                        Button(action: {
                                            ...
                                            Image(systemName: "envelope").padding(g.size.width/20)
                                        }
                                        ...
                                        Button(action: {
                                            ...
                                            Image(systemName: "location").padding(g.size.width/20)
                                        }
                                        Spacer()
                                        Button(action: {
                                            ...
                                            Image(systemName: "phone").padding(g.size.width/20)
                                        }
                                    }.padding(.bottom,15)
                            ...
                            VStack {
                                ...
                                HStack{
                                    ...
                                    Button(action: {
                                        ...
                                        Image(systemName: "phone").font(.title2).padding(g.size.width/15)
                                            .padding(.trailing,15).frame(width: 45, height: g.size.height/13, alignment: .center)
                                    }
                                ...
                                HStack{
                                    ...
                                    Button(action: {
                                        ...
                                        Image(systemName: "phone").font(.title2).padding(g.size.width/15).padding(.trailing,15)
                                            .frame(width: 45, height: g.size.height/13, alignment: .center)
                                    }
                                }.frame(width: g.size.width*0.93, height: g.size.height/13, alignment: .center)
                                .background(Color.black.opacity(0.4))
                                .cornerRadius(10.0)
                                ...
                                HStack{
                                    ...
                                    Button(action: {
                                        ...
                                        Image(systemName: "envelope").font(.title2).padding(g.size.width/15).padding(.trailing,15)
                                            .frame(width: 45, height: g.size.height/13, alignment: .center)
                                    }
                                }.frame(width: g.size.width*0.93, height: g.size.height/13, alignment: .center)
                                .background(Color.black.opacity(0.4))
